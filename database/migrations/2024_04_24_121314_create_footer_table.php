...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (!Schema::hasTable('footer')) {
            ...
            // Now that the table is created, insert the data
            DB::table('footer')->insert([
                'footer' => '<div class="container relative">
                    ...
                    <div class="row g-5 mb-5">
                        <div class="col-lg-4">
                            <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">BookWeb<span>.</span></a></div>
                            <p class="mb-4">Explore the vast realms of literature with BookWeb. Dive into worlds unknown, uncover mysteries untold. Let the written word ignite your imagination, guide your journey. Embrace the magic of storytelling. Welcome to BookWeb.</p>
