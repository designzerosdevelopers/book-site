            ...
            <div class="card-body">
                <form action="{{route('theme.update')}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="color" id="bg_color" name="bg_color" value="">
                        </div>

                        <label for="url_color" class="col-sm-2 col-form-label">URL Color:</label>
                        <div class="col-sm-4">
                            <input type="color" id="url_color" name="url_color" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="color" id="navbar_color" name="navbar_color" value="">
                        </div>

                        <label for="hero_color" class="col-sm-2 col-form-label">Hero Section Color:</label>
                        <div class="col-sm-4">
                            <input type="color" id="hero_color" name="hero_color" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="color" id="footer_color" name="footer_color" value="">
                        </div>
                    </div>
