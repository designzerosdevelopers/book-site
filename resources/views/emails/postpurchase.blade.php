...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_heading_8 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_content_heading_8 .v-text-align { text-align: center !important; } #u_content_divider_1 .v-container-padding-padding { padding: 10px 10px 10px 125px !important; } #u_content_text_2 .v-container-padding-padding { padding: 10px 10px 40px !important; } #u_content_text_2 .v-text-align { text-align: center !important; } #u_content_button_1 .v-size-width { width: 60% !important; } }
    </style>
...
<table id="u_content_heading_8" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-text-align" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 20px; font-weight: 400;"><span><span><strong>Subject: Password reset link</strong></span></span></h1>
...
<table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
    <p style="line-height: 140%;">Subject: Your Purchase Was Successfully Processed!.</p>
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;">Dear {{$customerName}}, </p>
    <p style="line-height: 140%;"> </p>
    <p style="line-height: 140%;">
      We hope this email finds you in great spirits and relishing your recent purchase from us! Your ongoing patronage is deeply appreciated, and we are immensely grateful for the confidence you place in our services/products.
      </p>
    <p style="line-height: 140%;"> </p>
...
<div class="v-text-align" align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com/templates" style="height:37px; v-text-anchor:middle; width:189px;" arcsize="11%"  stroke="f" fillcolor="#316b94"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
    <form action="{{ route('password.request') }}" method="GET" target="_blank">
      @csrf
