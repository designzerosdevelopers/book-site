...
@section('content')
		...
		<!-- Start Hero Section  -->
			<div class="hero">
                ...
                <p><a href="{{ $contact['button_1_url'] }}" class="btn btn-secondary me-2">{{ $contact['button_1_name'] }}</a><a href="{{ $contact['button_2_url'] }}" class="btn btn-white-outline">{{ $contact['button_2_name'] }}</a></p>
							</div>
						</div>
						<div class="col-lg-7">
